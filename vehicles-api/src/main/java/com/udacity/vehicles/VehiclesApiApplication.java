...
public class VehiclesApiApplication {
    ...
    CommandLineRunner createCar(CarRepository repository, ManufacturerRepository manuRepository) {
        return args -> {
            repository.save(new Car(Condition.NEW, new Details("COUPE", "SPORTS CAR", manuRepository.getOne(100))));
            repository.save(new Car(Condition.USED, new Details("SEDAN", "STATION WAGON", manuRepository.getOne(101))));
        };
    }
